...
class DooApiService(object):
    ...
    # 请求接口
    def call(self, api_path, method="GET", params=None):
        self._method = method.upper()
        self._params = demjson.encode(params if params is not None else {})
    ...
    def upload(self, api_path, params, file_path):
        ...
        http = urllib3.PoolManager(timeout=20.0)
        request_url = "{}{}".format(self.app_host, api_path)
        start_time = time.time()
