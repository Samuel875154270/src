...
class RunCppTest(unittest.TestCase):
    ...
    def test_api_position_trade(self):
        """
        MT4 在途订单开仓、修改、平仓，API使用
        :return:
        """
        login, symbol, volume = 2089106302, "USDJPY", 1
    ...
    def test_multi_trade(self):
        ...
        :return:
        """
        login, symbol, volume, follow_id = 2089106302, "USDJPY", 1, "multi test 123"
